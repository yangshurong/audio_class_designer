...
class MyWindow(QMainWindow):
    ...
    def show_figure_input(self):
        ...
        if not plt_info_input.empty():
            ...
            thread_list.append(Thread(target=self.plt_origin,args=(origin_y,)))
            thread_list.append(Thread(target=self.plt_ask_f,args=(askcode_y,)))
            thread_list.append(Thread(target=self.plt_origin_f,args=(origin_y,)))
            thread_list.append(Thread(target=self.plt_ask,args=(askcode_y,)))
        ...
        if not plt_info_output.empty():
            ...
            # print('arrive, out')
            thread_list.append(Thread(target=self.plt_midcarry_f,args=(midcarray_y,)))
            thread_list.append(Thread(target=self.plt_midcarray,args=(midcarray_y,)))
            thread_list.append(Thread(target=self.plt_recall,args=(recall_y,)))
